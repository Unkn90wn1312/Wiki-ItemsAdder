...
* [👋 Chào mừng](README.md)
* [❤ Đóng góp - Ủng hộ công việc của tôi](https://donate.devs.beer)
* [⚙ Cách cài đặt](first-install.md)
* [❓ Câu hỏi thường gặp](faq/README.md)
  * [🗿 3.3 vs 3.2](faq/3-3-vs-3-2.md)
  * [🔍 Gói tài nguyên không tải được](faq/identify-why-textures-are-not-shown.md)
  * [⚠ Plugin không hoạt động!](faq/plugin-doesnt-work.md)
  * [🇹🇷 Lỗi trong các máy tính ở Thổ Nhĩ Kỳ](faq/turkish-computer-errors.md)
  * [👁 Tôi thấy những texture sắc nét ở xa!](faq/i-see-crisp-textures-far-away.md)
  * [💧 Thanh khát/mana](faq/fill-thirst-mana-bar.md)
  * [👀 Tôi không thể thấy emoji, GUI, HUD...](faq/i-cant-see-emoji-guis-huds-etc..md)
  * [Kí tự ☐](faq/characters.md)
  * [Vấn đề với sách chế tạo](faq/recipes-book-problems.md)
  * [Texture của những cái đầu được đặt bị lỗi](faq/placed-heads-texture-glitched.md)
  * [🗑 Xóa bỏ những vật phẩm ban đầu](faq/removing-default-stuff/README.md)
    * [🗑 ItemsAdder phiên bản mới nhất](faq/removing-default-stuff/latest-itemsadder.md)
    * [🗑 ItemsAdder phiên bản cũ](faq/removing-default-stuff/old-itemsadder.md)
  * [🥾 Bị kick vì bay khi vào server](faq/kick-flight-on-join.md)
  * [🚙 Lỗi xe cộ](faq/vehicles-bugs/README.md)
    * [Vấn đề về việc xuống xe](faq/vehicles-bugs/dismount-related-problems.md)
    * [Không thể chat hay di chuyển](faq/vehicles-bugs/towny-vehicles-bug.md)
  * [💎 Vấn đề về khối/khoáng sản](faq/blocks-minerals-issues/README.md)
    * [Texture của block bị lỗi](faq/blocks-minerals-issues/custom-blocks-glitch-texture/README.md)
      * [Tránh những block bị lỗi](faq/blocks-minerals-issues/custom-blocks-glitch-texture/avoid-glitched-blocks.md)
      * [Khối nốt nhạc (REAL\_NOTE)](faq/blocks-minerals-issues/custom-blocks-glitch-texture/noteblocks-real\_note.md)
    * [Tôi đã xóa block nhưng nó liên tục nói rằng tôi đã dùng ID này rồi](faq/blocks-minerals-issues/i-removed-blocks-but-keep-saying-that-i-used-all-the-ids.md)
    * [Tôi không thể tìm được block khoáng sản](faq/blocks-minerals-issues/i-cant-find-any-mineral-ore.md)
    * [Block rơi ra nấm, quả chorus và khối nốt nhạc](faq/blocks-minerals-issues/blocks-drop-mushrooms.md)
    * [Vấn đề với 1 số block trong suốt](faq/blocks-minerals-issues/leaves-and-transparent-blocks-problems.md)
    * [Hiệu ứng block không hiển thị](faq/blocks-minerals-issues/block-particles-not-playing.md)
  * [💧 Lỗi về chất lỏng](faq/liquids-bugs.md)
  * [Bungeecord / Velocity](faq/bungeecord-velocity/README.md)
    * [Xóa gói tài nguyên khi thay đổi server](faq/bungeecord-velocity/remove-pack-on-server-change.md)
    * [Gói tài nguyên Bungeecord đơn (Cho từng server)](faq/bungeecord-velocity/single-resourcepack-bungeecord.md)
    * [Gói tài nguyên Bungeecord đơn (Với tính năng khác)](faq/bungeecord-velocity/single-resourcepack-multiple-server.md)
  * [📤 Không thể giải nén gói tài nguyên](faq/i-cant-unzip-the-pack.zip-file.md)
  * [Không thể đặt khung vật phẩm lên đồ đạc](faq/cant-place-itemframe-on-furniture.md)
  * [Không thể xóa bỏ đồ đạc và phương tiện](faq/i-cant-remove-furnitures-and-vehicles.md)
  * [Tải Spigot](faq/download-spigot.md)
  * [Tạo phiến, cầu thang, đinh ba, giáp, v.v.](faq/create-slabs-stairs-tridents-armors-etc.md)
  * [Vấn đề vói Mohist](faq/mohist-problems.md)
  * [⛔ Lỗi](faq/errors/README.md)
